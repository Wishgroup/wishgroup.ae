...
const PROJECT_IMAGES = [
  '/img/Project3/investment1.webp',
  '/img/Project3/tunaprime.webp',
  '/img/Project3/prawnsprime.webp',
  '/img/Project3/agriculture.webp',
]
...
function Project3() {
  ...
  const galleryImages = useMemo(() => PROJECT_IMAGES, [])
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{
                        ...
                        letterSpacing: '0.5px',
                        textTransform: 'uppercase'
                      }}>Secured by physical commodities</div>
                    </div>
                    <div>
                      <div style={{
                        fontSize: '20px',
                      ...
                      <div style={{
                        ...
                        letterSpacing: '0.5px',
                        textTransform: 'uppercase'
                      }}>Predictable yield structure</div>
                    </div>
                    <div>
                      <div style={{
                        fontSize: '20px',
                      ...
                      <div style={{
                        ...
                        letterSpacing: '0.5px',
                        textTransform: 'uppercase'
                      }}>Diversified commodity portfolio</div>
                    </div>
                    <div>
                      <div style={{
                        fontSize: '20px',
